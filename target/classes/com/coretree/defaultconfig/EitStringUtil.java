...
public class EitStringUtil {
    ...
    /**
     * <p>원하는 위치에 특정 문자를 추가한다.</p>
     *
     * <pre>
     * StringUtil.addChar(123456789, 5, "-")       = 12345-6789
     * StringUtil.addChar(123456789, 3, ",")       = 123,456789
     * </pre>
     *
     * @param str  입력받는 기준 문자열
     * @return " - "가 제거된 입력문자열
     *  입력문자열이 null인 경우 출력문자열은 null
     */
    public static String addChar(String str, int n, String ch) {
    	String rtnStr = null;
	...
	try {
		...
		Logger.getLogger(EitStringUtil.class).debug(e);//e.printStackTrace();
	}
...
/**
    ...
    public static String getHtmlStrCnvr(String srcString) {
		...
		{
			Logger.getLogger(EitStringUtil.class).debug(ex);//ex.printStackTrace();
		}
