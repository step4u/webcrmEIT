...
public class ExcelListReportDownload extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		try {
			...
			JSONArray excelList = JSONArray.fromObject(model.get("excelList"));
			...
			sheet.setColumnWidth((short) 1, (short) 18 * 300);
			sheet.setColumnWidth((short) 2, (short) 10 * 300);
			...
			sheet.setColumnWidth((short) 10, (short) 40 * 300);
			sheet.setColumnWidth((short) 11, (short) 10 * 300);
			/**
			* 헤더 폰트
			...
			*/
			...
			cell = row.createCell(1);
			cell.setCellValue(excelList.getJSONObject(i).getString("insertChk"));
			cell.setCellStyle(C_D_C_T_style);
			
			cell = row.createCell(2);
			cell.setCellValue(excelList.getJSONObject(i).getString("custCdNm"));
			cell.setCellStyle(C_D_C_T_style);
			...
			cell = row.createCell(5);
			cell.setCellValue(excelList.getJSONObject(i).getString("tel1No"));
			cell.setCellStyle(C_D_C_T_style);
			
			cell = row.createCell(6);
			cell.setCellValue(excelList.getJSONObject(i).getString("tel2No"));
			cell.setCellStyle(C_D_C_T_style);
			
			cell = row.createCell(7);
			cell.setCellValue(excelList.getJSONObject(i).getString("tel3No"));
			cell.setCellStyle(C_D_C_T_style);
			
			cell = row.createCell(8);
			cell.setCellValue(excelList.getJSONObject(i).getString("emailId"));
			cell.setCellStyle(C_T_L_T_style);
			
			cell = row.createCell(9);
			cell.setCellValue(excelList.getJSONObject(i).getString("faxNo"));
			cell.setCellStyle(C_D_C_T_style);
			
			cell = row.createCell(10);
			cell.setCellValue(excelList.getJSONObject(i).getString("addr"));
			cell.setCellStyle(C_T_L_T_style);
			...
			logger.debug("엑셀로 고객정보 저장 다운로드 완료.");
