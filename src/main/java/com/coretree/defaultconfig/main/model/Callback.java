...
public class Callback {
	...
	public String getResTelNo() {
		return EitStringUtil.isNullToString(resTelNo);
	}
	...
	public String toString() {
		return "Callback [cbSeq=" + cbSeq + ", resSeq=" + resSeq
				...
				+ ", resHms=" + resHms + ", counDate=" + counDate
				+ ", counHms=" + counHms + ", counCd=" + counCd + ", counCdNm="
				+ counCdNm + ", extensionNo=" + extensionNo + ", empNo="
				+ empNo + ", empNm=" + empNm + ", custNo=" + custNo
				+ ", custNm=" + custNm + ", resNote=" + resNote + "]";
	}
