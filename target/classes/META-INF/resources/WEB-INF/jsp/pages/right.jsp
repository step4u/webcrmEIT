...
<!-- 
	...
	function monitoringSearch(){
		right_param.empNo = $("input[name=empNo]").val();
		$.ajax({
			...
			success : function(result) {
				if(result != ""){
					...
					$("input[name=agtCbCounCnt]").val(result.agtCbCounCnt);
					$("input[name=totCbCounCnt]").val(result.totCbCounCnt);
					$("input[name=totCbResCnt]").val(result.totCbResCnt);
					$("input[name=agtRevCounCnt]").val(result.agtRevCounCnt);
					$("input[name=totRevCounCnt]").val(result.totRevCounCnt);
					$("input[name=totRevResCnt]").val(result.totRevResCnt);
...
<table width="320" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="20">
    	<span class='icon icon-chevron-right' id="rightSidr" style="font-size:20px;"></span>
    </td>
    <div id="sidr">
              ...
              <div class="panel">
                ...
                <div class="body fit">
                  ...
                  <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td class="right_td01"><input type="text" name="waitCnt" class="rightinput mini" value="0" style="width:45px" disabled="disabled"/></td>
            ...
            <tr>
              <td><div class="body fit">
                ...
                <table width="100%" align="center" class="table classic hover" id="empState">
                  <thead>
                    <tr>
                      <th style="width:50px">내선번호</th>
                      <th style="width:50px">상담원</th>
                      <th style="width:auto !important">상태</th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
                  ...
                  <div class="body fit">
                    <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="25%" class="right_txt02">콜백</td>
                        <td width="25%" class="right_txt02">상담예약</td>
                      </tr>
                      <tr>
                        <td width="18%" class="right_txt" width="50%"><%=session.getAttribute("empNm") %></td>
                        <td width="25%" class="right_td01"><input type="text" name="agtIbCnt" class="rightinput mini" value="" style="width:55px;" disabled="disabled" title="인바운드"/></td>
                        <td width="25%" class="right_td01"><input type="text" name="agtObCnt" class="rightinput mini" value="" style="width:55px" disabled="disabled" title="아웃바운드"/></td>
                        <td width="25%" class="right_td01"><input type="text" name="agtCbCounCnt" class="rightinput mini" value="" style="width:55px" disabled="disabled" title="콜백"/></td>
                        <td width="25%" class="right_td01"><input type="text" name="agtRevCounCnt" class="rightinput mini" style="width:55px" disabled="disabled" /></td>
                      </tr>
                      <tr>
                        <td width="18%" rowspan="2" class="right_txt" width="50%">전체</td>
                        <td width="25%" rowspan="2" class="right_td01"><input type="text" name="totAgtIbCnt" class="rightinput mini" style="width:55px; height:35px !important;" value="" disabled="disabled" /></td>
                        <td width="25%" rowspan="2" class="right_td01"><input type="text" name="totAgtObCnt" class="rightinput mini" style="width:55px;  height:35px  !important;" value="" disabled="disabled" /></td>
                        <td width="25%" class="right_td01"><input type="text" name="totCbCounCnt" class="rightinput mini" style="width:55px" value="" disabled="disabled" /></td>
                        <td width="25%" class="right_td01"><input type="text" name="totRevCounCnt" class="rightinput mini" disabled="disabled" style="width:55px"/></td>
                      </tr>
                      <tr>
                      	<!--  <td width="25%"></td>
                      	 <td width="25%" ></td> -->
                      	 <td width="25%" class="right_td01"><input type="text" name="totCbResCnt" class="rightinput mini" style="width:55px" disabled="disabled" /></td>
                      	 <td width="25%" class="right_td01"><input type="text" name="totRevResCnt" class="rightinput mini" style="width:55px" disabled="disabled" /></td>
                      </tr>
                      <tr>
                        <td width="18%" class="right_txt" width="50%">공지</td>
                        <td width="25%" class="right_td01"><input type="text" name="totBbsCnt" class="rightinput mini" style="width:55px" value="" disabled="disabled" /></td>
                      </tr>
                      <tr>
