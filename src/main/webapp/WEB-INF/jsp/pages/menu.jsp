			...
			<td>
				<div class="vmenu">
					...
					<ul class="submenu"  style="display:none">
						...
						<li><a onclick="win_10.show()">SMS 전송유형</a></li>
						<li><a onclick="win_11.show()">내선관리</a></li>
					</ul>
				</div>
			</td>
		</tr>
