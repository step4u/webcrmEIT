...
public class ExcelListReportDownload extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		try {
			...
			JSONArray excelList = JSONArray.fromObject(model.get("arr"));
			...
			sheet.setColumnWidth((short) 10, (short) 18 * 300);
			/**
			* 헤더 폰트
			...
			*/
			...
			cell = row.createCell(1);
			cell.setCellValue(excelList.getJSONObject(i).getString("cust_cdNm"));
			//System.out.println("==================================excelDownload" + excelList.getJSONObject(i).getString("cust_cdNm"));
			cell.setCellStyle(C_D_C_T_style);
			...
			cell = row.createCell(9);
			cell.setCellValue(excelList.getJSONObject(i).getString("fax_no"));
			cell.setCellStyle(C_D_C_T_style);
			...
			cell = row.createCell(11);
			cell.setCellValue(excelList.getJSONObject(i).getString("cust_note"));
			cell.setCellStyle(C_T_L_T_style);
